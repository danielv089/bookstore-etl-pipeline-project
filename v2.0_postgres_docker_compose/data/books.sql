...
\restrict MhrsPfIpuF66xWOXigINSz8rRCakaoGBTB2qc1iPnSvsGqGFJZrEDIwuIHegyss
...
--
-- Name: books books_upc_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.books
    ADD CONSTRAINT books_upc_fkey FOREIGN KEY (upc) REFERENCES public.in_stock(upc);
...
\unrestrict MhrsPfIpuF66xWOXigINSz8rRCakaoGBTB2qc1iPnSvsGqGFJZrEDIwuIHegyss
